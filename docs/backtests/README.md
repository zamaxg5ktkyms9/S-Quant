...
| ファイル | 内容 | 結果 | 参照 |
|---|---|---|---|
| `canonical_gapaware_2026-07-10.json` | **正準数字（現実的約定モデル）**: 現行構成の 2022-25 各年＋2026H1 | 4年平均 **+0.35%/月**、2026H1 **+2.25%/月** | §8.17 |
| `walkforward_rolling3_gapaware.json` | 現実的約定モデルでの WF 再検証 | ✅ 2/3 Robust | §8.17 |
| `oos_2026H1_600k_2026-07-10.json` | 2026 H1 真正 OOS（**旧約定モデル値** +3.46%/月 — §8.17 の正準表を参照） | 旧モデル・参考 | §8.16 |
